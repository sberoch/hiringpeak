...
export function LogoutButton() {
  return (
    <div className="px-5 py-4">
      <button
        className="flex items-center gap-2.5 text-[13px] w-full px-3 py-2.5 rounded-lg text-slate-brand hover:text-red-600 hover:bg-red-50/80 transition-all duration-200 group"
        onClick={() => {
          signOut({
