...
import {
  ...
  VacancyListReportQueryParamsSchema,
...
export class VacancyListReportQueryParams extends createZodDto(
  VacancyListReportQueryParamsSchema,
) {}
...
export type VacancyListReportServiceParams = VacancyListReportQueryParams & {
  organizationId: number;
};
